                                    ...
                                    <tr>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            <td>
                                                ...
                                                <?php /* Slug*/ ?>
                                                @if($row->field == 'name')
                                                    <a href="<?php echo $data->getUrl()?>"><?php echo $data->getTitle()?></a>
                                                @elseif($row->field == 'parent_id')
                                                <?php $category=\App\Models\Category::find($data->{$row->field}) ?>
                                                <?php if($category): ?>
                                                    <a href="<?php echo $category->getUrl()?>"><?php echo $category->getTitle()?></a>
                                                <?php else: ?>
                                                    <strong>Корневая</strong>
                                                <?php endif; ?>
                                                @elseif($row->field == 'album_id')
                                                    <?php if($album=$data->album): ?>
                                                    <a  href="/admin/albums/<?php echo $album->id?>"><?php echo $album->name?></a>
                                                    <?php else: ?>
                                                    <strong>Нет альбома</strong>
                                                     <?php endif; ?>
                                                @elseif($row->field == 'doors_album_id')
                                                    <?php if($album=$data->doors): ?>
                                                    <a  href="/admin/albums/<?php echo $album->id?>"><?php echo $album->name?></a>
                                                    <?php else: ?>
                                                    <strong>Нет альбома</strong>
                                                    <?php endif; ?>
